...
acc_list = [
    Account("젤리", 500),
    SavingsAccount("똥구미", 8000),
    CheckingAccount("누룽지", 80000)
]
...
# Java : 공통 인터페이스 구현 
# Python : 동일한 메소드 존재 여부만으로 실행가능 

print("=" * 60)

# 다중 상속 : 여러 부모클래스를 상속할 수 있음
...
class Serializable:
    def to_dict(self):
        return self.__dict__ # 모든필드를 딕셔너리로 변환
